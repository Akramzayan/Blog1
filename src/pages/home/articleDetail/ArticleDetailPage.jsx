...
import SocialShareButtons from "../../../componenets/SocialShareButtons";
      ...
      >
        ...
        <div>
          ...
          <div className="mt-7">
            ...
            <SocialShareButtons url={encodeURI("https://www.linkedin.com/in/akram-zayane/")} title={encodeURIComponent("Linkedin")}/>
          </div>
        </div>
      </section>
    </MainLayout>
