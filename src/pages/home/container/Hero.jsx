  ...
  return (
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
      <div className='mt-10 lg:w-1/2'>
        ...
        <p className='text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:mt-6 xl:mt-10 lg:text-left'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aut, minus!</p>
        <div className='flex flex-col gap-y-2.5 mt-10 relative'>
          <div className='relative'>
            <FiSearch className='absolute left-3 top-1/2  -translate-y-1/2 w-6 h-6 text-[#959Ead]'/>
            <input type="text" className='placeholder:font-bold font-semibold text-dark-soft placeholder:text-[#959EAD] rounded-lg pl-12 pd-3 w-full py-3 focus:outline-none shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] md:py-4'
